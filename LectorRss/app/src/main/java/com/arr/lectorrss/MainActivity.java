...
import com.arr.lectorrss.adapter.ListaAdapter;

import com.arr.lectorrss.bd.FeedBd;
import com.arr.lectorrss.http.HttpSingleton;
import com.arr.lectorrss.http.XmlRequest;
import com.arr.lectorrss.parser.Rss;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                TextView texto = (TextView) view.findViewById(R.id.descripcion);
                if (texto!=null) {
                    Intent intentDetalle = new Intent(MainActivity.this, DetalleActivity.class);
                    intentDetalle.putExtra("posicion",position+1);
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
                 HttpSingleton.getInstance(this).addToRequestQueue(
                        new XmlRequest<>(
                                URL_FEED,
                                Rss.class,
                                null,
                                new Response.Listener<Rss>() {
                                    ...
                                    public void onResponse(Rss response) {
                                        ...
                                        FeedBd.getInstance(MainActivity.this).sincronizarEntradas(response.getChannel().getItems());
            ...
            Log.i(TAG, getString(R.string.no_internet));
...
public class LoadData extends AsyncTask<Void, Void, Cursor> {
    ...
    protected void onPostExecute(Cursor cursor) {
        ...
        adapter = new ListaAdapter(MainActivity.this,cursor,SimpleCursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER);
        ListView listView = (ListView) findViewById(R.id.listado);
        listView.setAdapter(adapter);
    }
  }
